...
export default function AdminReportModal({ selectedReport, closeModal }) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <div className="mb-4">
          ...
          <input
            type="text"
            value={selectedReport.memberReportNo}
            readOnly

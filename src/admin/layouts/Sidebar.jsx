...
export default function Sidebar() {
  ...
  const handleAdminMember = () => {
    navigate('/_admin/member');
  }
        ...
        <nav className="mt-6">
          <div>
            ...
            >
              ...
              <span className="mx-4 text-sm font-normal">Member</span>
            </a>
            <a
              className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
              href="#"
            >
              ...
              <span className="mx-4 text-sm font-normal" onClick={handleAdminBoard}>Board</span>
            </a>
            <a
              className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
              href="#"
            >
              ...
              <span className="mx-4 text-sm font-normal" onClick={handleAdminParty}>Party</span>
            </a>
            <a
              className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
              href="#"

...
export default function ModalLogin({ isOpen, onClose }) {
  ...
  const handleGoogleLogin = () => {
    ...
    const redirectUri = encodeURI("https://gongzone.shop/google/callback");
  ...
  const handleNaverLogin = () => {
    ...
    const redirectUri = encodeURI("https://gongzone.shop/naver/callback");
    const state = Math.random().toString(36).substr(2, 11);
  ...
  const handleKakaoLogin = () => {
    ...
    const redirectUri = encodeURI("https://gongzone.shop/kakao/callback");
    const state = Math.random().toString(36).substr(2, 11);

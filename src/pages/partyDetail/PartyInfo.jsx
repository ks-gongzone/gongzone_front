    ...
    <div className="w-full max-w-6xl mx-auto mb-10 mt-14 px-4 sm:px-6 lg:px-8">
      ...
      {!isMember && (
        <button
          ...
          className="w-full h-10 mt-4 rounded-md bg-[#1d5091] text-white font-bold"
        >
          파티 신청하기
        </button>
      )}
        ...
        <>
          {detail.status === "S060103" ? (
            ...
            <button
              ...
              className="w-full h-10 mt-4 rounded-md bg-[#62c8b3] text-white font-bold"
            >
              제품 운송장 등록하기
            </button>
            ...
            <button
              type="button"
              className="w-full h-10 mt-4 rounded-md bg-[#ffa750] text-white font-bold"
              disabled
            >
            ...
            <button
              type="button"
              className="w-full h-10 mt-4 rounded-md bg-[#f97173] text-white font-bold"
              disabled
            >
              파티 종료
            </button>
